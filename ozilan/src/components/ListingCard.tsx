  ...
  if (variant === "mini") {
    return (
      <Link href={href} className="plaque-link group flex gap-3 overflow-hidden p-2.5">
        <ListingImage listing={l} className="h-14 w-16 shrink-0 rounded-md object-cover" />
    ...
    return (
      <Link href={href} className="plaque-link group flex flex-col gap-4 overflow-hidden p-3 sm:flex-row sm:items-start">
        <div className="relative w-full shrink-0 overflow-hidden rounded-md sm:w-48">
          <ListingImage listing={l} className="h-40 w-full sm:h-[132px]" />
    ...
    <Link href={href} className="plaque-link listing-motion-card group flex h-full flex-col overflow-hidden">
      <div className="listing-art-window relative overflow-hidden">
        <div className="listing-art-plane">
          <ListingImage listing={l} className="listing-artwork aspect-[4/3] w-full" />
        </div>
